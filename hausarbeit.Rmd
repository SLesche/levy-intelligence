...
I excluded all response times which deviated more than 3 standard deviations from the mean response time for a given participant in a given condition.  No further data-pruning was applied.
...
## SEM
The measurement model with method factors for all three tasks failed to fit. This full model always estimated the variance of one of the method factors to be negative. I therefore excluded one of the method factors from the model [Zitation for M-1 Models here] and only retained a factor for the Sternberg and Posner Task. 
