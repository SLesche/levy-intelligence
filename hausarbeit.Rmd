...
## SEM
The model showed acceptable fit `r print_sem(alpha_g)` and can be seen in Figure \@ref(fig:results-sem-alpha). On a latent level _alpha_ and _g_ correlated to $r = -.35$. 
